...
บน Windows ให้ตั้งค่า `LINE_MCP_EXTENSIONS=1` เพื่อแสดง **33 tools ที่ใช้งาน** และยังเรียก alias เดิม 5 ตัวที่ซ่อนจากรายการได้ หากไม่ตั้งค่านี้ จะแสดง **5 tools ค่าเริ่มต้น** macOS ก็แสดงทั้ง 5 ชื่อนี้เช่นกัน แต่รีลีสนี้ไม่รองรับการอ่าน การส่ง หรือการทำงานกับไฟล์
